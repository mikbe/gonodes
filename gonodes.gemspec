...
Gem::Specification.new do |s|
  ...
  s.description = %q{If you need to create simple (in the mathematical sense), weighted graphs with random values for the connections and weights then this is the gem for you.}
